...
import {
  ...
  withStyles,
  withTheme
} from "./chunk-2PZA7ZMO.js";
import "./chunk-JZBEP2OS.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-3IP47PSX.js";
import {
  _extends,
  init_extends
...
var AvatarGroup = React16.forwardRef(function AvatarGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime19.jsxs)(AvatarGroupRoot, _extends({
    ...
    children: [extraAvatars ? (0, import_jsx_runtime18.jsx)(AvatarGroupAvatar, _extends({
      ownerState,
      variant
...
var ToggleButton = React109.forwardRef(function ToggleButton2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiToggleButton"
  });
...
var ToggleButtonGroup = React110.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiToggleButtonGroup"
  });
  ...
  return (0, import_jsx_runtime128.jsx)(ToggleButtonGroupRoot, _extends({
    ...
    children: React110.Children.map(children, (child) => {
...
function useScrollTrigger(options = {}) {
  ...
  const store = React111.useRef();
  const [trigger, setTrigger] = React111.useState(() => getTrigger(store, other));
  React111.useEffect(() => {
    const handleScroll = () => {
